          ...
          <div className="grid grid-cols-2 items-center gap-6">
            ...
            <div className="col-span-1 origin-right scale-25 sm:scale-35 md:scale-55 lg:scale-75 xl:scale-100">
              <div className="text-center lg:text-right">
                ...
                <p className="hero-subtitle text-[clamp(1.8rem,6.1vw,1.95rem)] md:text-[1.6rem] lg:text-[1.9rem] text-gray-700 mb-0 sm:mb-8 leading-[clamp(2.7rem,7.8vw,2.9rem)] md:leading-[2.35rem] lg:leading-[2.7rem] font-semibold">
